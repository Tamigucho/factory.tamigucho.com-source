...
import pokemonTypes from '../data/creatures/types.json'; // Import the Pokemon types data
...
const PokemonItem = ({ id, name, type, photo, instagram, description }) => {
  let creaturePhoto = photo ? (photo.startsWith('http') ? photo : `${process.env.PUBLIC_URL}/${photo}`) : "default_image_url";
